...
internal class LoanRequestControllerTest{
    ...
    @MockBean
    private lateinit var loanReqeustServiceImpl: LoanReqeustServiceImpl
    ...
    fun init(){
        ...
        loanReqeustServiceImpl = LoanReqeustServiceImpl(
            generateKey, userInfoRepository, encryptComponent
        )
        loanRequestController= LoanRequestController(loanReqeustServiceImpl)
